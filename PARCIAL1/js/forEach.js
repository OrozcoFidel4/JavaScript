const numeros = [12, 53, 16, 12, 86];
const boolean = [true, false, true, true];
/*
numeros.forEach((variable)=> {
...
ej.forEach((ejercicio) => {
    console.log("Title: ", ejercicio.title);
    console.log("ID: ", ejercicio.id);
    console.log("Completed: ", ejercicio.completed);
    console.log("UserId: ", ejercicio.userId);
    console.log("-----------------------")
})